<%@ Page Language="vb" AutoEventWireup="false" MasterPageFile="~/Report.master" CodeBehind="exceptions-prices-add.aspx.vb" Inherits="cpa_reports.exceptions_prices_add" %>
...
<asp:Content ID="mainContent" ContentPlaceHolderID="mainContent" Runat="Server">
    <h1>Add Rental Fee</h1>
    <p>Fill in the fields to show the relevant details for a rental fee. (Rental fees are those that are incurred on top of the daily vehicle hire value). </p>
    ...
    <asp:Button ID="btnAddException" Text="Add Exception"  CommandArgument="AddException"  OnClick="btnAddException_Click"  runat="server" />
